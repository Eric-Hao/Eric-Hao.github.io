# News
- *2026.07*: [KAT-Coder-Pro V2.5](https://mp.weixin.qq.com/s/Ylz2hAbKs9gm5CXMfavIxw), a trillion-parameter-scale coding LLM with performance approaching GLM-5.2 and Claude Opus 4.8, was released. Its lightweight variant, [KAT-Coder-V2.5-Dev](https://huggingface.co/Kwaipilot/KAT-Coder-V2.5-Dev), was open-sourced at the same time; the broader model ecosystem has accumulated over 400K downloads and drawn strongly positive feedback from the community.
